...
const RestaurantUpdateId = (props) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const updatedRestaurant = await RestaurantFinder.update({id , name, location, price_range: priceRange});
        history.push("/");
      };
...
export default RestaurantUpdateId;